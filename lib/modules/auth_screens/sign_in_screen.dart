...
class _SignInScreenState extends State<SignInScreen> {
  ...
  @override
  void initState() {
    setCurrentScreen(screenName: 'SignInScreen');
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    lastScreen='SignInScreen';
                        ...
                        BlocConsumer<AuthCubit, AuthStates>(
                          ...
                          builder: (context, state) => state
                              ...
                              ? SizedBox(
                                  ...
                                  child: TextButton(
                                      onPressed: () {
                                        setCurrentAction(buttonName: 'ContinueAsGuestButton');
...
class _LoginViewState extends State<LoginView> {
  ...
  @override
  void initState() {
    setCurrentScreen(screenName: 'LoginView');
            ...
            Expanded(
              child: Form(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      if(enableForgetPasswordByEmail)...{
                      ...
                      BlocBuilder<AuthCubit, AuthStates>(
                        builder: (context, state) {
                          return SimpleLoginInputField(
                            ...
                            onSuffixPressed: () {
                              logg('suffix pressed');
                              setCurrentAction(buttonName: 'ChangePasswordVisibilityButton');
                        ...
                        children: [
                            ...
                            onPressed: () {
                              myAlertDialog(
                                  ...
                                  alertDialogContent: Column(
                                    ...
                                    children: [
                                      Visibility(
                                        visible: enableForgetPasswordByEmail,
                                        child: DefaultButton(
                                          title: localizationStrings.email,
                                          onClick: () {
                                            lastClickedButton='forgot password by email';
                                            setCurrentAction(buttonName: 'ForgetPasswordWithEmailButton');
                                      ...
                                      DefaultButton(
                                        ...
                                        onClick: () {
                                          lastClickedButton='forgot Password by phone';
                                          setCurrentAction(buttonName: 'ForgetPasswordWithPhoneButton');
                                          Navigator.pop(context);
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(
                         ...
                         ConditionalBuilder(
                          ...
                          builder: (context) => GestureDetector(
                            onTap: () {
                              lastClickedButton='login';
                              setCurrentAction(buttonName: 'LoginButton');
          ...
          children: [
                  ...
                  child: Column(
                    children: [
                      SimpleLoginInputField(
                        ...
                        inputFormatter: [
                          FilteringTextInputFormatter(RegExp(r'^[\u0621-\u064A0-9a-zA-Z]+'), allow: true)
                        ],
                      ),
                      SizedBox(
                        height: 15.h,
            ...
            BlocConsumer<AuthCubit, AuthStates>(
              ...
              builder: (context, state) => ConditionalBuilder(
                ...
                builder: (context) => GestureDetector(
                  onTap: () async {
                    lastClickedButton='sign up';
                    setCurrentAction(buttonName: 'SignUpButton');
                    FocusManager.instance.primaryFocus?.unfocus();

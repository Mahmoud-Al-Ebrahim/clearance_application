...
class _AddressesViewState extends State<AddressesView> {
  @override
  void initState() {
    setCurrentScreen(screenName: 'AddressesView');
                                    ...
                                    : (state is ChangingDefaultAddresses &&
                                        ...
                                        : GestureDetector(
                                            onTap: () {
                                              setCurrentAction(
                                                  buttonName:
                                                      'MakeAddressWithId=${address.id.toString()}DefaultButton');
                  ...
                  builder: (context, state) {
                    return Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            setCurrentAction(buttonName: 'RemoveAddressWithId=${address.id.toString()}Button');

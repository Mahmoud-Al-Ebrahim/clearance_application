...
class _MyAccountState extends State<MyAccount> {
  ...
  @override
  void initState() {
    setCurrentScreen(screenName: 'MyAccount');
          ...
          child: Padding(
              ...
              child: ConditionalBuilder(
                    ...
                    children: [
                          ...
                          return Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                DefaultButton(
                                  onClick: () {
                                    setCurrentAction(buttonName: 'SaveChangeProfileButton');
                      ...
                      Padding(
                        ...
                        child: DefaultButton(
                          onClick: () {
                            ...
                            setCurrentAction(buttonName: 'LogOutButton');
                      ...
                      authCubit.userInfoModel!.data!.email!
                          ...
                          : Padding(
                              ...
                              child: DefaultButton(
                                onClick: () {
                                  setCurrentAction(buttonName: 'DeleteAccountButton');
                                  myAlertDialog(
                                    context,
                ...
                fallback: (context) => Center(
                  child: InkWell(
                    onTap: () {
                      setCurrentAction(buttonName: 'joinUsButton');

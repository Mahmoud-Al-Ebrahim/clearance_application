...
class _AccountLayoutState extends State<AccountLayout> {
  ...
  @override
  void initState() {
    setCurrentScreen(screenName: 'AccountLayout');
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    lastScreen='AccountLayout';
    ...
    List<AccountItemsModel> mainListAccountItems = [
      ...
      AccountItemsModel(
          id: 3,
          svgImagePath: 'assets/images/account/settings.svg',
          title: localizationStrings.setting, apiOrderStatus: ''),
    ...
    List<AccountItemsModel> headerMainItems = [
      ...
      AccountItemsModel(
          id: 21,
          svgImagePath: 'assets/images/account/Card_icon.svg',
          title: localizationStrings.wallet, apiOrderStatus: ''),
      AccountItemsModel(
          id: 22,
          svgImagePath: 'assets/images/account/Location_Icon.svg',
          title: localizationStrings.address, apiOrderStatus: ''),
    ]..removeWhere((element) => (element.id==21 && !returnMoneyWithWallet));

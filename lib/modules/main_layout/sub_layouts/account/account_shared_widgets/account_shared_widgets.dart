...
import 'package:clearance/modules/main_layout/sub_layouts/account/sub_account/behaviors_stack_layout.dart';
import 'package:clearance/modules/main_layout/sub_layouts/account/sub_account/developer_settings_view.dart';
            ...
            return InkWell(
              ...
              child: Row(
                children: [
                  ...
                  InkWell(
                    onLongPress: () {
                      myAlertDialog(context, 'developer tools',
                            ...
                            children: [
                              if (showFeedBack!) ...{
                                ...
                                Padding(
                                  ...
                                  child: DefaultButton(
                                      title: localizationStrings!.feed_back,
                                      borderColors: primaryColor,
                                      onClick: () {
                                        navigateToWithNavBar(
                                            context,
                                ...
                                child: DefaultButton(
                                    ...
                                    onClick: () {
                                      navigateToWithNavBar(
                                          ...
                                          DeveloperSettingsView.routeName);
                                    }),
                              ),
                              10.verticalSpace,
                              Padding(
                                ...
                                EdgeInsets.symmetric(horizontal: 15.0.w),
                                child: DefaultButton(
                                    title: 'behavior stack',
                                    borderColors: primaryColor,
                                    onClick: () {
                                      navigateToWithNavBar(
                                          context,
                                          const BehaviorsStackLayout(),
                                          BehaviorsStackLayout.routeName);
                                    }),
                              ),
                              10.verticalSpace,
                            ],
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      showed
                          ? Text(
                              '${localizationStrings.version}$appVersionName',
                              style: mainStyle(15.0, FontWeight.w800,
                                  color: primaryColor),
                            )
                          : const SizedBox()
...
class ClearanceDropDownMenu<T> extends StatefulWidget {
  const ClearanceDropDownMenu({
    this.items,
    this.onChange,
    this.onSaved,
    this.onTap,
  ...
  @override
  State<ClearanceDropDownMenu> createState() => _ClearanceDropDownMenuState();
}

class _ClearanceDropDownMenuState<T> extends State<ClearanceDropDownMenu> {
  ...
  Widget build(BuildContext context) {
    return DropdownButtonFormField<T>(
      ...
      items: widget.items
        ...
        value: e,
        child: Text(
             e is String ? e : (getCachedLocal()== 'en' ? e.reasonEnglish : e.reasonArabic).toString(), style: mainStyle(16, FontWeight.w400)),
      ))
          .toList(),
      ...
      hint: widget.hint != null
          ? Text(
         widget.hint!,
        style:mainStyle(16, FontWeight.w400,color: primaryColor.withOpacity(0.3))
      )
          : null,
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Icon(Icons.keyboard_arrow_down_rounded,
            color: (widget.items?.isEmpty ?? true) ? primaryColor.withOpacity(0.3) : primaryColor),
      ),
    );
  }
}
    ...
    return InkWell(
      onTap: () {
        pushNewScreenWithRouteSettings(
          ...
          settings: const RouteSettings(name: '/ChangeLanguage'),
          withNavBar: false,
        );
      },
      child: Container(

...
class ExchangeRequestLayout extends StatefulWidget {
  ExchangeRequestLayout({Key? key,
    this.orderDetails,
  ...
  @override
  State<ExchangeRequestLayout> createState() => _ExchangeRequestLayoutState();
}

class _ExchangeRequestLayoutState extends State<ExchangeRequestLayout> {
  ...
  late final List<ValueNotifier<bool>> wantToExchange;
  bool isMakeAExchangeRequestPreviously = false;
              ...
              ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ValueListenableBuilder<bool>(
                      valueListenable: wantToExchange[index],
                              ...
                              if (isForRefund) ...{
                                ...
                                Form(
                                  ...
                                  child: Column(
                                    children: [
                                      20.verticalSpace,
                                      Text(localizationStrings.exchangeReason,
                                          style:
                                          mainStyle(18, FontWeight.bold)),
                                      5.verticalSpace,
                                      ClearanceDropDownMenu<Reason>(
                                        onChange: (selected) {
                                          wantToExchange[index].notifyListeners();
                                          reasons[widget
                                ...
                                BlocConsumer<AccountCubit, AccountStates>(
                                    ...
                                    builder: (context, state) {
                                      return (!accountCubit
                                          ...
                                          : DefaultButton(
                                        title: localizationStrings
                                            .cancel_product_exchange_request,
                                        onClick: () async {
                                          accountCubit
                  ...
                  builder: (context, state) {
                    return (!accountCubit.enableRequestRefund)
                      ...
                      child: DefaultButton(
                        ...
                        onClick: () async {
                          if (isMakeAExchangeRequestPreviously) {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) =>
                                        const ChooseProductsForExchange(
                                        )));
                          } else {
                            showTopModalSheetErrorMessage(
                                context,

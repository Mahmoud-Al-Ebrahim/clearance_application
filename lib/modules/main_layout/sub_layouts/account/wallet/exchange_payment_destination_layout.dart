...
class ExchangePaymentDestinationLayout extends StatelessWidget {
  ExchangePaymentDestinationLayout({Key? key }) : super(key: key);
    ...
    return Scaffold(
      ...
      body: BlocBuilder<AccountCubit, AccountStates>(
        builder: (context, state) {
          ...
          // selectedMethod.value = accountCubit.orderDetailsForRefundModel!.data!.returnRequestDestinationId ?? (selectedMethod.value==-1 ? accountCubit.paymentDestinationsModel!.data!.destinations![0].id! : selectedMethod.value);
                ...
                children: [
                  ...
                  Text(
                    accountCubit.orderDetailsForRefundModel!.data!
                        .totalRefundableAmountFormatted.toString(),
                    style: mainStyle(18, FontWeight.bold),
                  ),
                  10.verticalSpace,
                  Text(
                          ...
                          itemBuilder: (context, paymentIndex) {
                            ...
                            return GestureDetector(
                              ...
                              child: ReturnMoneyPaymentMethod(
                                ...
                                title: (locale=='en' ? dest.englishName : dest.arabicName ).toString(),
                      ...
                      BlocConsumer<AccountCubit, AccountStates>(
                          listener: (context, state) {
                            if(state is ConfirmReturnRequestSuccess){
                              showTopModalSheetErrorMessage(context , localizationStrings.confirmed_successfully);
                            }
                          },
                          builder: (context, state) {
                            return state is ConfirmReturnRequestLoading ? Center(

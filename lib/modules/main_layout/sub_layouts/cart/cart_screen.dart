...
class _CartScreenState extends State<CartScreen> {
  ...
  @override
  void initState() {
    setCurrentScreen(screenName: 'CartScreen');

    if(AccountCubit.get(context).walletModel==null){
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: ConditionalBuilder(
          ...
          builder: (context) => BlocListener<PaymentCubit, PaymentsStates>(
            listener: (context, paymentState) {
              if(paymentState is NoEnoughMoneyInWalletState){
                showTopModalSheetErrorMessage(context, localizationStrings!.no_enough_money_in_wallet);
              }
              if (paymentState is CheckAvailabilitySuccess &&
                  !paymentState.openVerificationOtp) {
                navigateToWithNavBar(context, const PaymentMainLayout(),
                    PaymentMainLayout.routeName);
              } else if (paymentState is CheckAvailabilityFailure &&
                  paymentState.fromCart) {
                    ...
                    children: [
                      ...
                      cartCubit.cartModel!.data!.restForFreeShipping! > 0
                          ? EnjoyFreeShippingWidget(
                              restValue: cartCubit.cartModel!.data!
                  ...
                  children: [
                            ...
                            childWidget: Row(
                              ...
                              children: [
                                ...
                                state is ApplyingCouponCode
                                    ...
                                    : GestureDetector(
                                        onTap: () {
                                          lastClickedButton = 'apply coupon';
                                          setCurrentAction(buttonName: 'ApplyCouponButton');
                                          cartCubit
                                              .applyCoupon(couponCont.text);
                                        },
                                        child: DefaultContainer(
                                          height: 40.h,
                                          width: 65.w,
                                          borderColor: applyCouponButtonColor,
                                          backColor: applyCouponButtonColor,
                                          childWidget: Center(
                                            child: Text(
                    ...
                    Row(
                      children: [
                              ...
                              Text(
                                localizationStrings.total +
                                    ...
                                    ((cartCubit.cartModel!.data!.hasCod! &&
                                        ...
                                        : cartCubit
                                            .cartModel!.data!.totalFormated
                                            .toString()),
                                style: mainStyle(20, FontWeight.bold),
                              ),
                              Row(
                                children: [
                                  Text(
                                    localizationStrings.discount + ': ',
                                    style: mainStyle(16, FontWeight.bold),
                                  ),
                                  Text(
                                    cartCubit.cartModel!.data!
                        ...
                        paymentState is PlacingOrderStateInPayment
                            ? Expanded(
                                child: SizedBox(
                                    height: 40.h,
                                    width: double.infinity,
                            ...
                            : Expanded(
                                child: GestureDetector(
                                  onTap: () {
                                    lastClickedButton = 'payment';
                                    setCurrentAction(buttonName: 'PaymentButton');
                                    if ((AuthCubit.get(context)
                                        ...
                                        AuthCubit.get(context)
                                                ...
                                                .data!
                                                .isVerifiedPhone ==
                                            0) && !AuthCubit.get(context).verifiedNow) {
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (_) =>
                                                  const GuestVerificationScreen())).then((value) {
                                        logg(value.toString());
                                        if (value != null) {
                                          ...
                                          paymentCubit
                                              .checkAvailabilityProducts(
                                                  openVerificationOtp: false);
                                        }
                                      });
                                    } else {
                                      paymentCubit.checkAvailabilityProducts(
                                          openVerificationOtp: false);
                                    }
                                  },
                                  child: DefaultContainer(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          setCurrentAction(buttonName: '${showMoreValue ? 'ShowMore':'ShowLess'}Button');
                        },
                        child: Align(
                          alignment: Alignment.center,
                          child: Text(
                            !showMoreValue
                                ? localizationStrings!.showMore
                                : localizationStrings!.showLess,
                            style: mainStyle(16.0, FontWeight.bold),
                          ),
                        ),
                      ),
                              ...
                              ? Column(
                                  ...
                                  children: [
                                    ...
                                    TableTwoValues(
                                      ...
                                      value: cartCubit
                                          .cartModel!.data!.subTotalFormated
                                          .toString(),
                                    ),
                                    TableTwoValues(
                                    ...
                                    TableTwoValues(
                                      mainKey:
                                          localizationStrings.couponDiscount,
                                      value: '- ' +
                                          cartCubit.cartModel!.data!
                                    ...
                                    TableTwoValues(
                                      mainKey:
                                          localizationStrings.estimated_tax,
                                      value: cartCubit.cartModel!.data!
                                ...
                                children: [
                                  showMoreValue
                                      ? (cartCubit.cartModel!.data!.hasCod! &&
                                          ...
                                          ? TableTwoValues(
                                              mainKey:
                                                  localizationStrings.tolls,
                                              mainKeyStyle: mainStyle(
                                  ...
                                  TableTwoValues(
                                    ...
                                    mainKeyStyle:
                                        mainStyle(14.0, FontWeight.w700),
                                    value: (cartCubit
                                                .cartModel!.data!.hasCod! &&
                                            paymentCubit.selectedPaymentId ==
                                                '3' &&
                                            inPaymentScreen)
                                        ? (double.parse(cartCubit
...
class CartItemBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<CartCubit, CartStates>(
      listener: (context,state){
        if(state is EditingCartCountSuccessStatus){
      ...
      builder: (context, state) => Container(
        ...
        child: BlocBuilder<PaymentCubit, PaymentsStates>(
            builder: (context, paymentState) {
          String? unAvailableMessage = paymentCubit.checkAvailabilityModel?.data
              ?.firstWhere((element) => element.id == cartItem.productId,
                  orElse: () => CheckedProduct(cartPosition: -1))
              .cause;
          return Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
                  ...
                  : Row(
                      children: [
                              ...
                              InkWell(
                                onTap: () {
                                  if ((cartItem.quantity! - 1) > 0) {
                                    setCurrentAction(buttonName: 'DecreaseQuantityButton');
                                    cartCubit.updateQty(
                                        itemIndex,
                              ...
                              InkWell(
                                onTap: () {
                                  if ((cartItem.quantity! + 1) <=
                                    ...
                                    setCurrentAction(buttonName: 'IncreaseQuantityButton');
                                    cartCubit.updateQty(
                                        itemIndex,
                                        (cartItem.quantity! + 1).toString(),
                                        cartItem.id.toString());
                        ...
                        Expanded(
                          ...
                          child: InkWell(
                            onTap: () {
                              setCurrentAction(buttonName: 'MoveItemToFavoriteFromCartButton');
                        ...
                        Expanded(
                          child: InkWell(
                            onTap: () {
                              setCurrentAction(buttonName: 'RemoveFromCartButton');
                            ...
                            child: Container(
                                ...
                                child: Center(
                                  child: state is RemovingCartItemState &&
                                          cartCubit.currentRemovingItemId ==
                                              cartItem.id.toString()
                                      ? DefaultLoader(
                                          customWidth: 25.w,
                                          customHeight: 25.h,

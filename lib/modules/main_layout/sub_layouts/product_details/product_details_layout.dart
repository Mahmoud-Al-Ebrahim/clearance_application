...
class ProductDetailsLayout extends StatefulWidget {
  ...
  static void Function()? popProductDetails = () {};
  final void Function()? onClick;

  @override
  State<ProductDetailsLayout> createState() => _ProductDetailsLayoutState();
}

class _ProductDetailsLayoutState extends State<ProductDetailsLayout> {
  late ProductDetailsCubit productDetailsCubit;

  @override
  void initState() {
    logg('initState');
    setCurrentScreen(screenName: 'ProductDetailsLayout');
    ...
    ProductDetailsLayout.popProductDetails = () {
      try {
  ...
  Widget build(BuildContext context) {
    lastScreen = 'ProductDetailsLayout';
          ...
          listener: (consumerContext, state) {
            if (state is PleaseChooseVariantState) {
              ...
              showModalBottomSheet(
                  ...
                  builder: (context) =>
                      BlocConsumer<ProductDetailsCubit, ProductDetailsStates>(
                        ...
                        listener: (context, state) {
                          if (state is ChoiceChangedState && state.popScreen) {
                            Navigator.pop(context, true);
                          }
                        },
                        buildWhen: (previous, current) =>
                            current is PleaseChooseVariantState,
                          ...
                          return SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    localizationStrings!.please_choose +
                                        (state as PleaseChooseVariantState)
                                            .message +
                                        ' :',
                                    style: mainStyle(
                                      16,
                ...
                if (state.quantity != null && value != null) {
                  productDetailsCubit.addToCart(
                      productId: widget.productId,
                      quantity: state.quantity!,
                      buyNow: state.fromBuyNowButton,
                      context: context);
                }
              });
              ...
              Navigator.popUntil(context, (route) => route.isFirst);
              mainCubit
                  .navigateToTapMethod((showNotifications! ? 3 : 2).toString());
            } else if (state is SuccessAddingToCartState) {
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: DefaultButton(
                                    ...
                                    onClick: () {
                                      lastClickedButton = 'continueShopping';
                                      setCurrentAction(
                                          buttonName: 'ContinueShoppingButton');
                ...
                return Padding(
                  ...
                  child: Stack(
                    children: [
                      ...
                      detailsData!.data!.hasWholeSale
                          ? DefaultButton(
                              title: localizationStrings!.talk_with_us,
                              onClick: () {
                                launchUrl(
                                    Uri.parse(
                                        'https://wa.me/${AccountCubit.get(context).contactUsModel!.data!.whatsAppPhone}/?text=${Uri.parse(detailsData!.data!.wholeSaleLink ?? localizationStrings.lbl_whatsapp_message)}'),
              ...
              Positioned(
                ...
                child: Builder(builder: (context) {
                  return GestureDetector(
                    onTap: () async {
                      setCurrentAction(
                          buttonName: 'TakeScreenShotAndShareButton');
                  ...
                  children: [
                    ...
                    BlocBuilder<ProductDetailsCubit, ProductDetailsStates>(
                      builder: (context, state) => QuantitySection(
                          availableQuantity: productDetailsCubit
                              .productDetailsModel!.data!.leftStock
                              .toString()),
                    ),
                    SizedBox(
                      height: 20.h,

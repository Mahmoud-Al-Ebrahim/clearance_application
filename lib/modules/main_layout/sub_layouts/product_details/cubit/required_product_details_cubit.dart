...
class RequiredProductDetailsCubit extends Cubit<RequiredProductDetailsState> {
  ...
  Map<String,bool> variationsSelectedRequired ={};
  String selectVariantMessageRequired="";
  ...
  void addSelectedChoiceRequired(BuildContext context, int id,
    ...
    logg('adding choices');
    variationsSelectedRequired[choiceTitle]=true;
    try {
      selectedChoicesRequired
  ...
  void increaseQtyRequired() {
    if (!getAllVariantsSelected()) {
      emit(PleaseChooseVariantState(
          message: selectVariantMessageRequired
      ));
      return;
    }
    ...
    await MainDioHelper.getData(
      ...
      if (productRequiredModel!.data!.choiceOptions!.isNotEmpty) {
        ...
        i++) {
          ...
          variationsSelectedRequired[productRequiredModel!.data!.choiceOptions![i].title!]=false;
  ...
  bool getAllVariantsSelected(){
    ...
    variationsSelectedRequired.forEach((key, value) {
      allVariantsSelected&=value;
      if(!value){
        selectVariantMessageRequired=key;
      }
    });

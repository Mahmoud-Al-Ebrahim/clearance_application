...
class ChoiceOptions extends StatelessWidget {
  const ChoiceOptions(
      {Key? key, required this.choiceOptions, this.required = false})
      : super(key: key);
                  ...
                  itemBuilder: (context, optionsIndex) {
                    return GestureDetector(
                      onTap: () {
                        ...
                        setCurrentAction(buttonName: 'ChoiceSelectingButton');
                        if (required) {
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              width: (required
                                              ? productDetailsCubitRequired
                                                  .selectedChoicesRequired
                                              : productDetailsCubit
                                                  .selectedChoices)
                                          .firstWhere((element) => element.choiceName == choiceOptions![index].name!,
                              ...
                              color: (required
                                              ? productDetailsCubitRequired
                                                  .selectedChoicesRequired
                                              : productDetailsCubit.selectedChoices)
                                          .firstWhere((element) => element.choiceName == choiceOptions![index].name!, orElse: () => SelectedChoice(id: 0, choiceVal: '', choiceName: ''))
                                          .choiceVal ==
                                      choiceOptions![index].options![optionsIndex]
                                  ? primaryColor
                                  : mainGreyColor),
                        ...
                        child: Center(
                          child: Text(
                              choiceOptions![index].options![optionsIndex],
                              style: mainStyle(14.w, FontWeight.w500),
...
class QuantitySection extends StatelessWidget {
  const QuantitySection(
      {Key? key, required this.availableQuantity, this.required = false})
      : super(key: key);
          ...
          child: Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  if (required) {
                    if (productDetailsCubitRequired
                      ...
                      showTopModalSheetErrorMessage(
                        context,
                        localizationStrings.max_quantity_reached,
                      );
                    }
                    return;
                  }
                  ...
                  child: Text(
                    required
                        ? productDetailsCubitRequired
                            .currentProductQuantityRequired
                            .toString()
                        : productDetailsCubit.currentProductQuantity.toString(),
...
class ColorOptions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var productDetailsCubitRequired = RequiredProductDetailsCubit.get(context);
    var selectedColor = required
        ? productDetailsCubitRequired.selectedColorRequired
        : productDetailCubit.selectedColor;
    return ConditionalBuilder(
            ...
            child: SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) => GestureDetector(
                  onTap: () {
                    setCurrentAction(buttonName: 'ColorSelectingButton');
                    if (required) {
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            width: 1.0,
                            color: colorOptions![index].code == selectedColor
                                ? Colors.black
                                : HexColor(
                                    colorOptions![index].code.toString())),
                      ),
                      width: colorOptions![index].code == selectedColor
                          ? 25.h
                          : 15.h,
                    ),
                  ),

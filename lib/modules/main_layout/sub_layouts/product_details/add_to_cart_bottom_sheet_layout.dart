...
class AddToCartBottomSheetContent extends StatefulWidget {
  const AddToCartBottomSheetContent(
      {required this.productId, this.onClick, Key? key})
      : super(key: key);
...
class _AddToCartBottomSheetContentState
  ...
  @override
  void initState() {
    setCurrentScreen(screenName: 'AddToCartBottomSheetContent');
  ...
  Widget build(BuildContext context) {
    lastScreen = 'AddToCartBottomSheetContent';
    ...
    return BlocConsumer<RequiredProductDetailsCubit,
        ...
        listenWhen: (p, c) => ModalRoute.of(context)?.isActive ?? false,
        listener: (consumerContext, state) {
          ...
          if (state is PleaseChooseVariantState) {
            showTopModalSheetErrorMessage(
                context, localizationStrings!.please_choose + state.message);
        ...
        builder: (context, state) {
          return ConditionalBuilder(
            ...
            builder: (context) {
              int? availableQty =
                  productDetailsCubit.updatedVariationRequired != null
              ...
              String? maxPrice;
              for (var element in productDetailsCubit
                  .productRequiredModel!.data!.variation!) {
                    ...
                    child: InkWell(
                      ...
                      child: SizedBox(
                        ...
                        child: DefaultImage(
                          ...
                          backGroundImageUrl: productDetailsCubit
                              .productRequiredModel!.data!.image!,
                ...
                Positioned(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      setCurrentAction(buttonName: 'CloseBottomAddToCartSheetButton');
                    },
                    child: Transform.translate(
                      ...
                      children: [
                        ...
                        BlocBuilder<RequiredProductDetailsCubit,
                          ...
                          builder: (context, state) => ChoiceOptions(
                              choiceOptions: productDetailsCubit
                                  .productRequiredModel!.data!.choiceOptions,
                              required: true),
                        ),
                        SizedBox(
                          height: 20.h,
                        ...
                        BlocBuilder<RequiredProductDetailsCubit,
                          ...
                          builder: (context, state) => QuantitySection(
                              availableQuantity: productDetailsCubit
                                  .productRequiredModel!.data!.leftStock
                                  .toString(),
                              required: true),
                        ),
                        SizedBox(
                        ...
                        productDetailsCubit
                                    .productRequiredModel!.data!.colors ==
                                null
                            ? const SizedBox()
                            : BlocBuilder<RequiredProductDetailsCubit,
                                RequiredProductDetailsState>(
                                builder: (context, state) => ColorOptions(
                                  colorOptions: productDetailsCubit
                                      .productRequiredModel!.data!.colors,
                                ),
                              ),
                        const Spacer(),
                        widget.onClick == null
                            ? GestureDetector(
                                onTap: () {
                                  setCurrentAction(buttonName: 'AddToCartButton');
                                  if (availableQty! > 0) {
                                    if (productDetailsCubit
                                            .productRequiredModel!
                                            .data!
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: state is AddingToCartState &&
                                            !state.buyNowButton
                                        ? DefaultLoader(
                                            customWidth: 42.w,
                                            customHeight: 42.w,
                            ...
                            : GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      localizationStrings.add_to_exchange,

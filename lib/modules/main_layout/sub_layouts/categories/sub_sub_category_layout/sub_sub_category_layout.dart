...
class _SubSubCategoryLayoutState extends State<SubSubCategoryLayout>  {
  ...
  @override
  void initState() {
    setCurrentScreen(screenName: 'SubSubCategoryLayout');
  ...
  void pagination() {
    ...
    CategoriesCubit.get(context).getFilteredCategoryProducts(widget.cateId, token,pagination: true);
    }
  }
  String? token;
  @override
  Widget build(BuildContext context) {
    ...
    lastScreen='SubSubCategoryLayout';
    logg(widget.cateId);
    var categoriesCubit = CategoriesCubit.get(context)
      ..updateCurrentCateId(widget.cateId)
      ..resetFilters();
    categoriesCubit.getFilteredCategoryProducts(widget.cateId, token);
                                ...
                                children: [
                                  Expanded(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        setCurrentAction(buttonName: 'SortProductsButton');
                                  ...
                                  Expanded(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        setCurrentAction(buttonName: 'FilterProductsButton');
  ...
  buildFiltersModalBottom(BuildContext context,
    ...
    var localizationStrings = AppLocalizations.of(context);
     setCurrentScreen(screenName: 'FilterDialog');
                                        ...
                                        if (categoriesCubit.productsFilteredByCateModel!.data!
                                          ...
                                          await FilterListDialog.display<Price>(
                                            ...
                                            validateSelectedItem: (list, val) =>
                                                list!.contains(val),
                                            onResetButtonClick: resetAllSelectedFilters,
  ...
  buildSortByModalBottom(BuildContext context,
    ...
    var localizationStrings = AppLocalizations.of(context);
    var categoriesCubit = CategoriesCubit.get(context);
    setCurrentScreen(screenName: 'SortDialog');
    showMaterialModalBottomSheet(
      context: context,
      builder: (context) =>
